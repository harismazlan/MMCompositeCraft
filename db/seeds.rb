...
ActiveRecord::Base.transaction do
  800.times do 
    ...
    boat['condition'] = ["New", "Used"].sample
    boat['price'] = rand(30000..400000)
    boat['make_type'] = ["Sail", "Power"].sample
    ...
    boat['fuel_type'] = ["Diesel", "Gas"].sample
    boat['hull_material'] = ["Wooden", "Fibreglass", "Composite", "Steel"].sample
    Boat.create(boat)
  end
end
...
ActiveRecord::Base.transaction do
    200.times do
        ...
        appointment['appointment_status'] = ["Pending", "Rejected", "Accepted"].sample
