...
gem 'mini_magick', '~> 4.8'
# Use Rubocop to abide by the standard guide and practice for code readability
gem 'rubocop', '~> 0.73.0', require: false
# Use Rails_best_practices to enforce best coding practices for ruby on rails
